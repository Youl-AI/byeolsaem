...
export const PLAIN_OVERRIDES: Partial<Record<`${PlanetKey}-${number}`, string>> = {
  // 태양-1: "당신이 서 있는 방식이 당신 자신과 첫인상에 있습니다" — "당신"이 두 번 겹친다.
  "sun-1": "스스로 서 있는 방식이 당신 자신과 첫인상에 있습니다",
  ...
  // 목성-4: "넓히려는 마음이 집과 마음의 바닥에 있습니다" — "마음"이 두 번 겹친다.
  "jupiter-4": "넓히려는 기운이 집과 마음의 바닥에 있습니다",
  // 명왕성-3: "밑바닥의 힘이 말과 가까운 관계에 있습니다" — 힘/결속 쪽 표현이 대화 자리와 어색하게 붙는다.
  // 행성 쪽 핵심어 "힘"은 남기고 조합만 부드럽게 바꾼다.
  "pluto-3": "밑바닥에서 올라오는 힘이 말과 가까운 관계에 있습니다",
};
