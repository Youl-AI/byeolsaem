...
const PAGE_CARDS = [
  ...
  { file: "blog/mercury-retrograde-2027.png", eyebrow: "COLUMN", title: "2027 수성 역행", sub: "세 번의 날짜와 그림자 기간", motif: "loop" },
  { file: "blog/mars-retrograde-2027.png", eyebrow: "COLUMN", title: "2027 화성 역행", sub: "1월 10일부터 4월 1일까지", motif: "loop" },
  { file: "blog/lunations-2027.png", eyebrow: "COLUMN", title: "2027 신월과 보름", sub: "스물다섯 번의 정확한 시각", motif: "moon" },
  { file: "blog/jupiter-virgo-2027.png", eyebrow: "COLUMN", title: "목성 처녀자리", sub: "2027년 7월부터 1년", motif: "wheel" },
  { file: "blog/uranus-gemini.png", eyebrow: "COLUMN", title: "천왕성 쌍둥이자리", sub: "84년 만에 돌아온 자리", motif: "rings" },
  { file: "blog/saturn-aries-2027.png", eyebrow: "COLUMN", title: "토성 양자리", sub: "시작의 자리를 조이는 2년 반", motif: "horizon" },
  { file: "blog/year-2027.png", eyebrow: "COLUMN", title: "2027년 하늘 일정", sub: "역행과 삭망과 자리 이동 전부", motif: "horizon" },
